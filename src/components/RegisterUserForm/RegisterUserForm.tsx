...
// 			message: "Username must be at least 2 characters.",
// 		}),
// 		confirmedPassword: z.string().min(2, {
// 			message: "Username must be at least 2 characters.",
// 		}),	
...
// 							<FormItem>
// 								<FormControl>
// 								<Checkbox id="showPassword" checked={field.value} {...field} />
// 								</FormControl>
// 								<FormLabel htmlFor="showPassword">
// 								Show Password
// 								</FormLabel>
// 							</FormItem>
// 						)}
...
const RegisterUserForm = () => {
  ...
  const onSubmit = (formData: z.infer<typeof formSchema>) => {
    ...
    registerUser(userData);
    dispatch({ type: 'REGISTER_USER', payload: userData }); // Adjust this action as per your redux setup
  };
